...
class WorkRequest {
   ...
   * @throws IOException
   *           on error parsing the document
   */
  public static WorkRequest fromJson(final InputStream json) throws IOException {
  ...
  /**
   * @param value
   *          the Amazon S3 bucket to write to
   */
  ...
  /**
   * @param value
   *          the Amazon S3 object key to write to
   */
  ...
  /**
   * @param value
   *          the message to write to Amazon S3
   */
   ...
   * @throws IOException
   *           on error serializing the value
   */
