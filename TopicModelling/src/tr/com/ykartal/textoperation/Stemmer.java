...
public class Stemmer {
    ...
    /**
     * r(s) is used further down. sets (j+1),...k to the characters in the string s if
     * 
     * @param s
     */
    ...
    /**
     * @param articleStore
     *            store where articles taken from and stemmed each word
     */
    public static void runStemmer(final IArticleGetter articleStore) {
        List<S3ObjectSummary> articleList = articleStore.getArticleList();
        for (S3ObjectSummary s3ObjectSummary : articleList) {
            String article = articleStore.getArticle(s3ObjectSummary.getKey());
            article = runStemmer(article);
            articleStore.storeArticle(s3ObjectSummary.getKey(), article);
        }
    }
     ...
     */
    public static String runStemmer(final String content) {
        char[] w = new char[501];
